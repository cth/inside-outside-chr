...
inside_done,
rule(NF,[NJ,NG],PF), outside(NF,P,E,PaF), inside(NJ,_Lvl,P,Q,PbJ) ==>
	Q1 is Q + 1,
	PJ is PF * PaF * PbJ
	|
	write('outside_right_rec: '), write(rule(NF,[NJ,NG],PF)), write(','), write(outside(NF,P,E,PaF)), write(','), write(inside(NJ,_,P,Q,PbJ)), write('==>'), write(outside(NG,Q1,E,PJ)), nl,
	outside(NG,Q1,E,PJ).
